...
int test_one_el_remove_el(void)
{
    ...
    LinkedList_remove_with_compare_func(&s, (int(*)(void*, void*))strcmp, CHAR_STRING_TEST);
...
int test_two_el_remove_last_el(void)
{
    ...
    LinkedList_remove_with_compare_func(&s, (int(*)(void*, void*))strcmp, CHAR_STRING_TEST2);
    if(LinkedList_get_count(&s) != 1)
    {
        ret = 1;
        fprintf(stderr, "count does not match : %zu <> %d\n", LinkedList_get_count(&s), 1);
...
int test_three_el_remove_last_el(void)
{
    ...
    LinkedList_remove_with_compare_func(&s, (int(*)(void*, void*))strcmp, CHAR_STRING_TEST3);
    if(LinkedList_get_count(&s) != 2)
    {
        ret = 1;
        fprintf(stderr, "count does not match : %zu <> %d\n", LinkedList_get_count(&s), 1);
...
int test_three_el_remove_not_found(void)
{
    ...
    LinkedList_remove_with_compare_func(&s, (int(*)(void*, void*))strcmp, CHAR_STRING_TEST4);
    if(LinkedList_get_count(&s) != 3)
    {
        ret = 1;
        fprintf(stderr, "count does not match : %zu <> %d\n", LinkedList_get_count(&s), 1);
